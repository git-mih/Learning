...
# Slots have doesnt lock class atributes, we still can create new class attributes.
# but it will lock the instance attributes.
...
s.name = 'Alex'
s.__dict__  # {}  exists, we do have an instance dict
...
# a slotted attribute isnt stored in an instance dicttionary
...
# in both cases, the attributes are present in the class dictionary but with slots,
# it essentially create properties (getters, setters, deleters and storage) for us.
